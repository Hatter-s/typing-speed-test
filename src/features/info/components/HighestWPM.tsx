...
export default function HightestWPM() {
  ...
  return (
    <div className="flex flex-row flex-nowrap items-center gap-125 bg-neutral-900">
      <img src={iconPersonalBest} alt="icon-personal-best" className="h-200 md:h-4.5" />
      <p className="cus-text-4 flex flex-row flex-nowrap items-center gap-50 text-neutral-400">
